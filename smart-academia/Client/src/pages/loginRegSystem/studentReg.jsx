...
const StudentRegistration = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    confirmPassword: "", department: "Computer Science", semester: "1st",
  });
  ...
  const fieldConfig = {
    ...
    studentId: {
      ...
      successMsg: "Valid Student ID!", errorMsg: "Format: XXX-XX-XXXX",
    },
    email: {
  ...
  const validateForm = () => {
    ...
    Object.keys(fieldConfig).forEach(field => {
      ...
      const isValid = field === "confirmPassword"
        ? validation(formData[field], formData) : validation(formData[field]);
