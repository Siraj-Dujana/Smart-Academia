...
const Register = () => {
  ...
  // ========== ANIMATION EFFECTS ==========
  useEffect(() => {
    const timer1 = setTimeout(() => setAnimateLogo(true), 300);
  ...
  // ========== GLOW CARD COMPONENT (role selector) ==========
  const GlowCard = ({ icon, label, onClick, isSelected }) => {
    return (
      <div
        ...
        style={{
          background: "#0c0e1e",
          border: `1px solid ${isSelected ? "rgba(255,255,255,0.6)" : "rgba(255,255,255,0.1)"}`,
        }}
        onClick={onClick}
      >
        ...
        {/* Selected indicator */}
        {isSelected && (
          <div className="absolute top-1.5 right-1.5 w-2.5 h-2.5 rounded-full bg-white animate-pulse" />
        )}
      </div>
    );
  };
      ...
      <div className="min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center w-1/2 p-12 text-center relative overflow-hidden" style={{ background: "#0c0e1e" }}>
          ...
          <div className="relative flex flex-col items-center gap-6 max-w-md z-10">
            ...
            {/* Feature Highlights - matches BenefitsSection card pattern */}
            <div className="grid grid-cols-2 gap-3 mt-8 w-full">
              {features.map((feature) => (
                ...
                >
                  <div
                    className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                    style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(255, 255, 255, 0.15) 0%, transparent 80%)" }}
                  />
          ...
          <div className="w-full max-w-md space-y-6 py-6">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-3">
                <input
                  className="h-4 w-4 rounded mt-0.5 flex-shrink-0 accent-white"
                  style={{ background: "#1e293b", borderColor: "rgba(255,255,255,0.2)" }}
                  id="terms"
                  name="terms"
                  type="checkbox"
