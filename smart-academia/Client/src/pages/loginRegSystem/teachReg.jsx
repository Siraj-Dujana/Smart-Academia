        ...
        <div className={`relative ${shake[fieldName] ? 'animate-shake' : ''}`}>
          ...
          <input
            className={`w-full px-4 py-3 pl-10 pr-10 rounded-xl text-white placeholder-gray-500 outline-none transition-all duration-200 text-sm focus:ring-1 focus:white ${
              ...
              : success[fieldName] ? "border border-green-500"
              : "border"
            }`}
            style={{
              background: "#1e293b",
              borderColor: errors[fieldName] || success[fieldName] ? undefined : "rgba(255,255,255,0.06)",
            }}
          ...
          />
          {isPasswordField && (
            <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-300 transition-colors"
  ...
  return (
    <div className="h-screen w-full overflow-hidden" style={{ fontFamily: "'Lexend', sans-serif", background: "#0c0e1e" }}>
      ...
      <div className="flex flex-col lg:flex-row h-full w-full">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center w-1/2 h-full relative overflow-hidden" style={{ background: "#0c0e1e" }}>
              ...
              {[
                ...
                <div key={s.num} className="flex flex-col items-center gap-2">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${
                    step === s.num ? "bg-white text-black scale-110 shadow-lg" :
        ...
        <div className="flex-1 flex flex-col items-center justify-start p-6 overflow-y-auto custom-scroll" style={{ background: "#0c0e1e", height: "100vh" }}>
            ...
            {step === 2 && (
              <form onSubmit={handleVerifyAndRegister} className="space-y-6">
                <div className="flex justify-center">
                  <div className="flex items-center justify-center w-16 h-16 rounded-full" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)" }}>
                    <span className="material-symbols-outlined text-2xl text-white">mark_email_unread</span>
                  </div>
                </div>
            ...
            {step !== 3 && (
              <div className="text-center pt-4">
                <p className="text-sm text-gray-500">
                  ...
                  <button onClick={() => navigate('/login')} className="font-bold text-white hover:text-gray-300 transition-all hover:scale-105">
                    Sign in
                  </button>
                </p>
              </div>
