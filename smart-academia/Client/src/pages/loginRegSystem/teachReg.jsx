...
const TeacherRegistration = () => {
  ...
  /**
   * Manages all form data for teacher registration
   */
        ...
        <div className="lg:hidden flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-800 p-6 sm:p-8 text-center">
          <div className="flex flex-col items-center gap-4 max-w-md w-full">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-4">
              {["Course Management", "AI Analytics", "Student Progress", "Secure"].map((feature, index) => (
                <span 
                  key={feature}
          ...
          <div className="w-full max-w-2xl">
            ...
            <div className="lg:hidden text-center mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm sm:text-base">
                Join Smart Academia as an educator
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 lg:p-8 shadow-sm">
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                {/* Name and Employee ID - Responsive Grid */}
                ...
                {/* Department and Specialization - Responsive Grid */}
                <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2">
