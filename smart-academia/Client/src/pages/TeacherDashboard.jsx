...
const TeacherDashboard = () => {
  ...
  const menuItems = [
    ...
    { icon: "note_stack",   label: "Share Notes",       key: "share-notes" },  
    { icon: "bar_chart",    label: "Student Progress",  key: "progress" },
    { icon: "auto_awesome", label: "AI Insights",       key: "ai-analytics" },
    { icon: "leaderboard",  label: "Course Rankings",   key: "course-rankings" },
    { icon: "smart_toy",    label: "AI Tutor",          key: "ai-tutor" },
    { icon: "send",         label: "Send Notifications",key: "send-notifications" },
