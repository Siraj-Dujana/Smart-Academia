  ...
  return (
    ...
    >
      <div className="p-3 sm:p-4 flex-1">
          ...
          {isEnrolled && (
            <div className="relative w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[10px] sm:text-xs font-bold text-gray-900 dark:text-white">{course.progress || 0}%</span>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 p-2 sm:p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        ...
        {isEnrolled ? (
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm font-medium px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-all">
            ...
            <button
              ...
              className="px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm border border-red-200 dark:border-red-700 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
              title="Unenroll">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm font-medium px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-all">
