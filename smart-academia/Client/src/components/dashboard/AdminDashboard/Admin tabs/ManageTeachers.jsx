...
const ManageTeachers = () => {
  ...
  // Departments
  const departments = ["Computer Science", "Mathematics", "Physics", "Biology", "Chemistry", "History", "Arts", "Engineering"];
  ...
  const handleAddTeacher = () => {
    if (newTeacher.name && newTeacher.email && newTeacher.department) {
      ...
      setNewTeacher({ name: "", email: "", department: "", courses: "", status: "active" });
