...
const Avatar = ({ user, size = 96, onUpload, onDelete, uploading }) => {
  ...
  return (
    <div className="relative inline-block">
      <div
        className={`relative flex items-center justify-center rounded-full overflow-hidden cursor-pointer transition-all hover:scale-105 ${
          user?.avatar ? "border-2 border-indigo-500" : "bg-gradient-to-br from-indigo-600 to-purple-600 border-2 border-indigo-500"
        }`}
      ...
      <div className="relative rounded-2xl overflow-hidden p-6 sm:p-8" style={{ background: "linear-gradient(135deg, #0c0e1e 0%, #131b35 50%, #0d1527 100%)", border: "1px solid #1e293b" }}>
        ...
        <div className="relative">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-semibold text-indigo-400 uppercase tracking-widest">SmartAcademia · Profile</p>
          </div>
