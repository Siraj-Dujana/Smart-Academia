    ...
    <div className="space-y-5 sm:space-y-6 md:space-y-8">
      ...
      {isLoading ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm">Loading students...</p>
        </div>
      ) : (
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {filtered.map(student => (
                  <tr key={student._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-150">
                    ...
                    {/* Joined Date */}
                    <td className="px-3 sm:px-4 py-3 text-gray-500 dark:text-gray-400 text-xs hidden lg:table-cell">
                  ...
                  <tr>
                    <td colSpan={5} className="px-4 py-12 text-center">
                      <div className="text-center">
                        <span className="material-symbols-outlined text-5xl sm:text-6xl text-gray-300 dark:text-gray-600 mb-4">groups</span>
